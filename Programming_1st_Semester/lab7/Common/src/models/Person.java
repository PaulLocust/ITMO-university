...
public class Person implements Serializable {
    ...
    public void validate() throws WrongPersonException {
        try {
            if (this.name == null || this.name.isEmpty()) throw new WrongPersonException("Name");
            if (this.height <= 0) throw new WrongPersonException("Height");
            if (this.eyeColor == null) throw new WrongPersonException("Eye color");
    ...
    */
    ...
    public static Person fillPerson(Scanner scanner) {
        ...
        try {
            System.out.println("Entering a Person object");
            person.name = (String) ConsoleReader.conditionalRead(scanner, "Enter name: ", false, String::toString, Objects::nonNull, (m) -> !m.equals(""));
            person.height = (float) ConsoleReader.conditionalRead(scanner, "Enter height: ", false, Float::parseFloat, (m) -> Float.parseFloat(m) > 0);
            person.eyeColor = Color.fillColor(scanner);
            ...
            System.err.println("You haven't fully introduced Person!");
        }
        return person;
    }
