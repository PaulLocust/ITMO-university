...
public class Interpreter extends Thread {
    ...
    public Interpreter(Sender sender,DatagramSocket socket, String sqlLogin, String sqlPassword) throws InvocationTargetException,
            NoSuchMethodException, InstantiationException, IllegalAccessException, CommandAlreadyExistsException, RightException,
            IOException, SameIdException, ClassNotFoundException {
    ...
    public void interpret(Request request, DatagramPacket packet) {
        ...
        AbstractCommand cmd = request.getCommand();
